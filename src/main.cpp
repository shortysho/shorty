...
const string strMessageMagic = "shorty Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 20) // SHORTY ICO RESERVED
    {
        nSubsidy = 5000000 * COIN; // 100 Milion
    }
    else if(pindexBest->nHeight < 100000) // 100000 Blocks with 0 rewards
    {
        nSubsidy = 0 * COIN;
    }
...
// shorty: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "shorty", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "SHORTY & VINE ";
        CTransaction txNew;
        txNew.nTime = 1480845864;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x34fa61b253a80316567619b45ed78ac1d60bcbdf7f0dc97a39e220485f1fde4f"));
        block.print();
